...
public class BlockPostApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Location loc1 = new Location("chennai");
		Location loc2 = new Location("hyderabad");

		Users user1 = new Users("virat", "kohli", loc1, "virat@gmail.com");
		Users user2 = new Users("sharma", "Rohit", loc1, "rohit@gmail.com");
		Users user3 = new Users("dhoni", "ms", loc2, "dhoni@gmail.com");
		Users user4 = new Users("yuvi", "singh", loc2, "yuvia@gmail.com");

		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
		LocalDate d1 = LocalDate.parse("12/16/2019", formatter);
		LocalDate d2 = LocalDate.parse("10/05/2016", formatter);
		LocalDate d3 = LocalDate.parse("09/06/2020", formatter);
